...
class InformacionBasicaForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'fecha_ingreso_gobierno':      forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}, format='%Y-%m-%d'),
            'fecha_ingreso_dependencia':   forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}, format='%Y-%m-%d'),
            'fecha_ingreso_puesto':        forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}, format='%Y-%m-%d'),
